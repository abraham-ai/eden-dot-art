...
async function getAuthToken(data) {
  const response = await axios.post(GATEWAY_URL + '/sign_in', data)
  const authToken = response.data.authToken
  return authToken
}

async function startPrediction(data) {
  const response = await axios.post(GATEWAY_URL + '/request', data)
  return response
}
