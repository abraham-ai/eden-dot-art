...
// ANTD
import { Avatar, Divider, Row, Col, Tag, Typography, Button,
Popover } from 'antd' // Skeleton, 
    ...
    <RelatedCreationsStyles id='cr-related-wrapper'>
        <Row className='cr-related-header'>
            <span style={{ display: 'flex' }}>
              <SearchOutlined style={{ color: 'black', fontSize: '1.5rem', marginRight: 10 }} />
              <Title level={3}>Related Creations</Title>
            </span>

            <Button 
              className='cr-search-more'
              shape='round' 
              size='large'
            >
            ...
            return (
              <Row key={i} className='cr-related-creation'>
                ...
                <Col style={{ display: 'flex', flexDirection: 'column'}}>
                  ...
                  <Text style={{ color: '#717171' }}>{formatAddress(item.source.address)}</Text>
                  <Row style={{ display: 'flex', alignItems: 'center' }}>
                    <span style={{ display: 'flex', alignItems: 'center', color: '#717171', marginRight: 10 }}>
                        <FaRegStar className='icon' style={{ marginRight: 5, color: '#717171' }} />
                        <Text style={{ color: '#717171' }}>{100}</Text>
                    </span>
                    <span className='cr-related-creation-date' style={{ color: '#717171' }}>
                      {time_ago(item.date)}
                    </span>
                  </Row>
                </Col>
        ...
        <Row className='cr-post'>
          ...
          <section className='cr-main'>
            ...
            <Row style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <Title level={4} style={{ margin: 0 }}>{item.text_input}</Title>
            </Row>
            ...
            <Row className='cr-main-header'>
                ...
                <Popover content={<ProfilePopOver profileAddress={'0x000000000'} />}  placement="bottomLeft">
                  <Avatar 
                      className='cr-creator-profile' 
                      icon={
                        <Blockies 
                          seed={item.source.address} 
                          scale={6} 
                        />} 
                    />
                </Popover>
                  ...
                  <Row className='cr-creator-name-wrapper'>
                    <Title className='cr-creator-name' level={3} style={{ margin: 0 }}>
                      {formatAddress(item.source.address)}
                    </Title>
                    <Row>
                      <Text>{formatAddress(item.source.address)}</Text>
                      <Text style={{ marginLeft: 20 }}>{time_ago(item.date)}</Text>
                    </Row>
                  </Row>
                </Row>
