...
// STYLES
import SettingsButtonStyles from '@/components/Account/ProfileButton/ProfileButtonStyles'
...
export const SettingsButtonCustom = () => {
                ...
                return (
                  ...
                  >
                    <Button
                      ...
                      icon={
                        isHovering ? <SettingTwoTone /> : <SettingOutlined />
                      }
                    />
                  </Popover>
                )
...
export default SettingsButtonCustom
