                    ...
                    <Card className='edit-profile-form-wrapper'>
                        ...
                        >
                            <Row className='form-row'>
                                ...
                                <Col className='form-info' span={12}>
                                    <Form.Item className='form-item'
                                        label={<Space className='form-label-wrapper'>
                                                  <Text className='form-label'>
                                                    Name
                                                  </Text>
                                                  <Text className='form-label-optional'
                                                        type='secondary'        
                                                  >
                                                    Optional
                                                  </Text>
                                                </ Space>}
                                        labelCol={{ span: 24 }} colon={false}>
                                    ...
                                    {isUsernameAvailable
                                        ? <Alert message={`Username ${'test'} is available`} type='success' style={{ height: 30 }} />
                                        : <Alert message={`Username ${'test'} is unavailable`} type='error' style={{ height: 30, color: 'red' }} />
                                    }
                                </Col>
                            </Row>
                                ...
                                <Col className='form-info' span={12}>
                                    <Space className='form-header'>
                                        ...
                                        <Text className='form-description'>
                                            Add your email address to receive notifications about your activity on Eden. This will not be shown on your profile.
                                        </Text>
                                    </Space>
                                </Col>
                                <Col className='form-info' span={12}>
                            ...
                            <Row className='form-row'>
                                ...
                                <Col className='form-info' span={12}>
                                    <Form.Item className='form-item text-area'
                                        label={<Space
                                                    className='form-label-wrapper text-area'>
                                                    <Text className='form-label'>
                                                        Enter a short bio
                                                    </Text>
                                                    <Text className='form-label-optional'
                            ...
                            <Row className='form-row'>
                                <Col className='form-info' span={12}>
                                    <Space className='form-header'>
                                        ...
                                        <Text className='form-description'>{'Recommended size: 1000x1000px'}</Text>
                                        <Text className='form-description'>{'JPG, PNG, or GIF.'}</Text>
                                        <Text className='form-description'>{'10MB max size'}</Text>
                                    </Space>
                                </Col>
                                <Col className='form-input-wrapper upload' span={12} style={{ flexFlow: 'column' }}>
                                    ...
                                    >
                                        <Upload action="/upload.do" listType="picture-card" style={{background: 'red'}}>
                                            <div>
                                                <PlusOutlined />
                            ...
                            <Row className='form-row'>
                                <Col className='form-info' span={12}>
                                    <Space className='form-header'>
                                        ...
                                        <Text className='form-description'>{'Recommended size: 1500x1500px'}</Text>
                                        <Text className='form-description'>{'JPG, PNG, or GIF.'}</Text>
                                        <Text className='form-description'>{'10MB max size'}</Text>
                                    </Space>
                                </Col>
                            ...
                            <Row className='form-row' style={{ flexDirection: 'column' }}>
                                <Col className='form-info' span={24} style={{ flex: 0, minHeight: 'unset', paddingBottom: 15 }}>
                                    <Space className='form-header'>
                                        <Text className='form-title'>
                                            Add links to
                                        </Text>
