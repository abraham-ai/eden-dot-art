...
//   let response = await axios.post(EDEN_API_URL + "/api-key/create", {}, {
//     headers: {
...
//   const response = await axios.get(EDEN_API_URL + "/generators");
...
//   let response = await axios.post(EDEN_API_URL + "/media", form, {
//     headers: {
//       ...form.getHeaders(),
//       Authorization: `Bearer ${authToken}`,
//     }
...
//   };
//   let responseR = await axios.post(EDEN_API_URL + "/tasks/create", request, {
//     headers: {
//       Authorization: `Bearer ${authToken}`,
//     },
//   });
...
//   const response = await axios.post(EDEN_API_URL + "/tasks/fetch", data, {
//     headers: {
//       Authorization: `Bearer ${authToken}`,
//     },
//   });
...
//     ? await axios.post(EDEN_API_URL + "/fetch", {
//       userIds: [userId],
//     })
//     : { data: [] };
//   return response;
